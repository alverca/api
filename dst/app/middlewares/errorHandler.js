...
const debug = createDebug('@chevre/api:middlewares:errorHandler');
exports.default = (err, __, res, next) => {
    ...
    if (err instanceof api_1.APIError) {
        ...
        if (Array.isArray(err)) {
            ...
            // 500
            apiError =
                new api_1.APIError(http_status_1.INTERNAL_SERVER_ERROR, [new chevre.factory.errors.Chevre('InternalServerError', err.message)]);
        }
    }
